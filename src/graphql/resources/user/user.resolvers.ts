...
export const userResolvers = {
    ...
    User: {
        accessgroup: (user, args, {db, dataloaders: {accessgroupLoader}}: {db: DbConnection, dataloaders: DataLoaders}, info: GraphQLResolveInfo) => { 
            return accessgroupLoader
                .load({key: user.get('accessgroup'), info})
                .catch(handleError);
        },
    },
